...
public class Scenario {
	...
	public void Run()
	{
	 ...
	 void printResultByVehicleActuatedSetting()
	 {
		 System.out.print("****** Table statistics for question 3 actuaced model*************"+"\n");
			System.out.print("ExpectedValueXg: " + ResultManager.getExpectedValueXg2()+"\n");
			System.out.print("ExpectedValueXg2nd: " + ResultManager.getExpectedValueXg2nd2()+"\n");
			System.out.print("getExpectedValueX0: " + ResultManager.getExpectedValueX02()+"\n");
			System.out.print("ExpectedValueofAvgQueuelength: " + ResultManager.getExpectedValueofAvgQueuelength()+"\n");
			System.out.print("ExpectedDelay: " + ResultManager.getExpectedDelay()+"\n");
			System.out.print("ExpectedDelay2nd: " + ResultManager.getExpectedDelay2nd()+"\n");
			System.out.print("ProbabilityX0is0: " + ResultManager.getProbabilityX0is02()+"\n");
			System.out.print("ProbabilityXgis0: " + ResultManager.getProbabilityXgis02()+"\n");
			System.out.print("*********Variance******************* " +"\n");
			System.out.print("Variance of Xg: " + ResultManager.getVarianceXg2()+"\n");
			System.out.print("Variance of X0: " + ResultManager.getVarianceX02()+"\n");
			System.out.print("Variance of X: " + ResultManager.getVarianceX()+"\n");
			System.out.print("Variance of Delay: " + ResultManager.getVarianceDelay()+"\n");
			System.out.print("****** upper and lower bound of 95% confidence interval**** " +"\n");
			System.out.print("*************Upper************Lower************** " +"\n");
